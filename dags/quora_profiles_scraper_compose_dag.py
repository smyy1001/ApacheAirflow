...
PROJECT_DIR = "/opt/projects/scraper5"       # docker-compose'daki isim
COMPOSE_FILE = "docker-compose.yaml"
PROJECT_NAME = "quora_profiles_scraper_airflow"
...
with DAG(
    dag_id="quora_profiles_scraper_compose_dag",
    ...
    docker compose -p "{PROJECT_NAME}" -f "{COMPOSE_FILE}" up --build quora_profiles_playwright --abort-on-container-exit
    """.strip()
