...
PROJECT_NAME = "quora_trends_scraper_airflow"
...
with DAG(
    dag_id="quora_trends_scraper_compose_dag",
    ...
    docker compose -p "{PROJECT_NAME}" -f "{COMPOSE_FILE}" up --build quora_trends_playwright --abort-on-container-exit
    """.strip()
