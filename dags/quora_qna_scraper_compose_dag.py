...
PROJECT_NAME = "quora_qna_scraper_airflow"
...
with DAG(
    dag_id="quora_qna_scraper_compose_dag",
    ...
    docker compose -p "{PROJECT_NAME}" -f "{COMPOSE_FILE}" up --build quora_qna_playwright --abort-on-container-exit
    """.strip()
