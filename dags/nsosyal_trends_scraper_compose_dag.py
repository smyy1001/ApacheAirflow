...
PROJECT_NAME = "nsosyal_trends_scraper_airflow"
...
with DAG(
    dag_id="nsosyal_trends_scraper_compose_dag",
    ...
    docker compose -p "{PROJECT_NAME}" -f "{COMPOSE_FILE}" up --build nsosyal_scrapy_trend --abort-on-container-exit
    """.strip()
